...
export const dummyBanks: BankAccount[] = [
  {
    $id: "bank1",
    accountId: "account1",
    bankId: "bank1",
    accessToken: "dummyAccessToken1",
    fundingSourceUrl: "http://example.com/funding1",
    userId: "user1",
    sharableId: "sharable1",
  ...
  },
  {
    ...
    fundingSourceUrl: "http://example.com/funding2",
    userId: "user2",
    sharableId: "sharable2",
    currentBalance: 434000,
    id: "account2",
